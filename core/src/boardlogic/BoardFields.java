...
public class BoardFields {
    ...
    private static Field[] initFields(float boardX, float boardLength) {
        ...
        return new Field[]{
                ...
                new Field(1, "Verwoehne dich beim Juwelier \"Bling Bling & Bling\". Zahle 170.000 Euro.",boardX + (boardLength / 14f), boardLength / 8.5f),
                new Field(2, "Goenne dir eine goldene Handyhuelle. Zahle 50.000 Euro.",boardX + (boardLength / 8.5f), boardLength / 1.08f),
                ...
                new Field(6, "Du kaufst ersatzteile fuer deinen Opel Corsa. Zahle 100.000 Euro.",boardX + (boardLength / 1.45f), boardLength / 12),
                ...
                new Field(10, "Du klaust das Zuhause eines Bettlers. Du erhaelst 50 Euro.",boardX + (boardLength / 1.449f), boardLength / 3.2f),
                new Field(11, "Alles Gute zum Geburtstag! Du erhaelst 5.000 Euro",boardX + (boardLength / 1.35f), boardLength / 2.9f),
                ...
                new Field(14, "Du kaufst nutzlose antike Gegenstaende. Zahle 50.000 Euro.",boardX + (boardLength / 2.43f), boardLength / 5),
                new Field(15, "Zu viel trainiert. Gehe zum Osteopathen. Zahle 50.000 Euro.",boardX + (boardLength / 2.83f), boardLength / 5),
                new Field(16, "Du klaust meine Unterhose. Du erhaelst 50 Euro.",boardX + (boardLength / 2.90f), boardLength / 7),
                new Field(17, "Deine Eltern haben Hochzeitstag! Ueberrasche Sie mit einer VIP-Weltreise. Zahle 100.000 Euro",boardX + (boardLength / 3.25f), boardLength / 11.5f),
                new Field(18, "Du kaufst Lotterielose ohne Gewinn. Zahle 50.000 Euro",boardX + (boardLength / 4f), boardLength / 19),
                new Field(19, "Exklusive Fotoshooting fuer ein Cosplaymagazin Kassiere 50.000 Euro.",boardX + (boardLength / 5.5f), boardLength / 23),
                new Field(20, "Du klaust den Schuh eines Bettlers. Du erhaelst 50 Euro.",boardX + (boardLength / 9f), boardLength / 15),
                ...
                new Field(24, "Du kaufst zwei Biber. Zahle 100.000 Euro",boardX + (boardLength / 7f), boardLength / 2.9f),
                new Field(25, "Poledance ist schmerzhaft! Gehe zum Osteopathen. Zahle 50.000 Euro.",boardX + (boardLength / 4.95f), boardLength / 2.85f),
                ...
                new Field(27, "Der Mitgliedsbeitrag fuer den Golfclub ist faellig. Zahle 50.000 Euro.",boardX + (boardLength / 4.95f), boardLength / 2.14f),
                ...
                new Field(30, "Heute haste frei",boardX + (boardLength / 4.95f), boardLength / 1.55f),
                new Field(31, "Kaufe eine Discokugel aus Diamanten. Zahle 150.000 Euro",boardX + (boardLength / 7f), boardLength / 1.53f),
                new Field(32, "Du klaust den Hut eines Bettlers. Du erhaelst 50 Euro.",boardX + (boardLength / 12f), boardLength / 1.45f),
                new Field(33, "Verwoehne dich in einem obszoenen Etablissement. Zahle 30.000 Euro",boardX + (boardLength / 20f), boardLength / 1.33f),
                new Field(34, "Nix zu tun",boardX + (boardLength / 22f), boardLength / 1.22f),
                new Field(35, "Verwoehne deinen Hund mit einem Halsband aus Rubinen. Zahle 30.000 Euro",boardX + (boardLength / 14f), boardLength / 1.13f),
                new Field(36, "Du bist auf einem Hamster ausgerutscht. Kassiere 10.000 Euro",boardX + (boardLength / 5.5f), boardLength / 1.05f),
                new Field(37, "Du klaust den Hut eines Bettlers. Du erhaelst 50 Euro.",boardX + (boardLength / 4f), boardLength / 1.06f),
                ...
                new Field(40, "Kaufe Anteile an nachhaltigen Kohlebergwerken! Zahle 70.000 Euro.",boardX + (boardLength / 2.83f), boardLength / 1.26f),
                new Field(41, "Du verletzt dich bei einem Wrestlingmatch! Du erhaelst 200.000 Euro.",boardX + (boardLength / 2.90f), boardLength / 1.36f),
                // MINIGAME AUKTIONSHAUS
                new Field(42, "Auktionshaus",boardX + (boardLength / 3.25f), boardLength / 1.455f),
                new Field(43, "Deine Oma benoetigt ein neues Facelifting. Zahle 80.000 Euro",boardX + (boardLength / 3.9f), boardLength / 1.52f),
                new Field(44, "Du verkaufst die Uni Klagenfurt. Du erhaelst 250 Euro.",boardX + (boardLength / 2.43f), boardLength / 1.26f),
                new Field(45, "Du klaust Kinder. Du erhaelst 50 Euro.",boardX + (boardLength / 2.13f), boardLength / 1.26f),
                ...
                new Field(53, "Deine Mutter klaut dein Geld fuer eine neue Handtasche. Zahle 200.000 Euro.",boardX + (boardLength / 1.14f), boardLength / 1.08f),
                new Field(54, "Verwoehne deine Hausratte mit Socken aus Kaschmir! Zahle 40.000 Euro.",boardX + (boardLength / 1.055f), boardLength / 1.22f),
                ...
                new Field(58, "Goenn dir einen mit Champagner gefuellten Jacuzzi. Zahle 60.000 Euro.",boardX + (boardLength / 1.255f), boardLength / 1.56f),
                new Field(59, "Goenn dir eine Schoenheits-OP (welche du unbedingt benoetigst). Zahle 60.000 Euro.",boardX + (boardLength / 1.255f), boardLength / 1.71f),
                new Field(60, "Du klaust den Hut eines Mitspielers. Du erhaelst 50 Euro.",boardX + (boardLength / 1.255f), boardLength / 1.9f),
                new Field(61, "Du kaufst Mankomania. Zahle 100.000 Euro.",boardX + (boardLength / 1.255f), boardLength / 2.13f),
                new Field(62, "Spendiere einem Spieler deiner Wahl eine Verjuengerungskur Zahle 100.000 Euro.",boardX + (boardLength / 1.255f), boardLength / 2.43f),
                new Field(63, "Du versenkst deine Yacht im Woerthersee. Zahle 200.000 Euro.",boardX + (boardLength / 1.255f), boardLength / 2.85f),
                new Field(64, "Verwoehne dein Pony mit Beinwaermern aus Kaschmir! Zahle 50.000 Euro.",boardX + (boardLength / 1.17f), boardLength / 2.9f),
